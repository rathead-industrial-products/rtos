/*******************************************************************************
    ...
    eex_arm.c - Non architecture portable functions.

    Link this file in place of eex_console.c when running on
    an ARM m0 or m4 platform.
...
#include  <stdint.h>
#include  "sam.h"       // must have a manuf include file to define processor type, intrinsics, and other stuff
#include  "eex_os.h"
